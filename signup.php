        ...
        if (preg_match($pattern, $_POST['password'])) {
            if (preg_match($pattern1, $cmobileno)) {
                ...
                if (mysqli_num_rows($checkUser) > 0) {
                    ...
                    $query = mysqli_query($con, "INSERT INTO tbladmin(UserName, Email, Password, MobileNumber) values('$username', '$email', '$password',  '$mobilenumber') ");
                    if ($query) {
                    ...
                    <div class="col-xl-7 pa-0 ">
                        <div class="auth-form-wrap py-xl-0 py-50 ">
                            <div class="auth-form w-xxl-55 w-xl-75 w-sm-90 w-xs-100 ">
                                <form method="post">
                                    <h1 class="text-pink display-4 mb-10">SingUp</h1>
                                    ...
                                    <button class="btn  btn-block bg-pink-light-1 text-white " type="submit" name="signup">SignUp</button>
                                    <p class="font-14 text-center mt-15 text-pink">

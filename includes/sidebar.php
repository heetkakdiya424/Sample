                    ...
                    <ul class="navbar-nav flex-column">
                            ...
                            <ul id="cats_drp" class="nav flex-column collapse collapse-level-1">
                                <li class="nav-item">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="add-subcategory-category.php">Add-Sub-Category</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="manage-categories.php">Manage Category</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="manage-sub-categories.php">Manage Sub-Category</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                            ...
                            <ul id="product_drp" class="nav flex-column collapse collapse-level-1">
                                <li class="nav-item">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="bulk-add-product.php">Bulk-Add</a>
                                        </li>
                                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <i class="glyphicon glyphicon-shopping-cart"></i>
                                <span class="nav-link-text">Product Sales</span>
                            </a>
                        </li>
